...
// ISO 3166-1 alpha-2 → Unicode regional indicator flag emoji (no image assets, no network calls).
...
// Georgia first (primary market), then the rest alphabetically by name.
