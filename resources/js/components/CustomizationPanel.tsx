                                ...
                                <div key={key}>
                                    ...
                                    <div className="relative">
                                        <input
                                            type="number"
                                            placeholder="0"
                                            value={design.sizeCm[key as keyof typeof design.sizeCm] ?? ''}
                                            onChange={e => updateCm(key, e.target.value)}
                                            className="w-full border border-slate-200 rounded-lg px-2 py-2 text-sm pr-6 focus:outline-none focus:ring-2 focus:ring-slate-900"
                                        />
