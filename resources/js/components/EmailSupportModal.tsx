            ...
            <div className="bg-white rounded-2xl w-full max-w-lg shadow-xl">
                ...
                {sent ? (
                    <div className="px-6 py-10 text-center">
                        ...
                        <p className="text-sm text-slate-500">{t('emailSupport.sentHint')} <strong>{user.email ?? user.phone}</strong>.</p>
                        <Button
                            variant="default"
                            onClick={handleClose}
                    ...
                    <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                readOnly
                                value={`${user.first_name} ${user.last_name} <${user.email ?? user.phone}>`}
