                                        ...
                                        <div className="p-6 flex flex-col flex-1">
                                            <div className="flex items-start justify-between mb-1">
                                                <div className="min-w-0">
                                                    ...
                                                    {tailor.specialty && <p className="text-sm text-slate-500 truncate">{tailor.specialty}</p>}
                                                </div>
                                                ...
                                                <div className="flex items-center gap-3">
                                                    {tailor.years_experience != null && (
                                                        <span className="flex items-center gap-1">
                                                            ...
                                                            {tailor.years_experience} {t('ourTailors.yrs')}
                                                        </span>
                                                    )}
                                                    {tailor.products_count > 0 && (
                                                        <span className="flex items-center gap-1">
                                                            <Scissors className="w-3.5 h-3.5 text-slate-400" />
                                                            {tailor.products_count} {tailor.products_count === 1 ? t('ourTailors.productOne') : t('ourTailors.productMany')}
                                                        </span>
                                                    )}
                                                </div>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 justify-center">
                            ...
                            <Link to="/marketplace" className="border border-slate-300 text-slate-700 font-semibold px-8 py-3 rounded-full hover:border-slate-500 transition-colors">
                                {t('ourTailors.browseMarketplace')}
                            </Link>
                        </div>
                    </motion.div>
                </div>
