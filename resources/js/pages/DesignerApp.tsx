...
function CategoryStep({
    ...
    const visibleCategories = CATEGORY_KEYS.filter(cat => gender !== 'men' || ['shirt', 'trousers', 'jacket', 'coat'].includes(cat.key));
    ...
    return (
        ...
        >
            ...
            <motion.button
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: visibleCategories.length * 0.07 }}
