            ...
            <div className="w-full px-2 pt-11 pb-8 sm:px-3 lg:px-4">
                ...
                <div className="mb-5 grid grid-cols-[1fr_auto_1fr] items-center gap-3 border-y border-[#111111]/20 py-3">
                    <div className="hidden">
                        <p className="mb-3 text-[10px] font-bold text-[#111111] uppercase">{t('marketplace.categoryLabel')}</p>
                        <div className="space-y-1">
                            ...
                            {categories
                                .filter((c) => audience !== 'men' || !WOMEN_ONLY_CATEGORY_SLUGS.includes(c.slug))
                                .map((c) => (
                                    <button
                                        key={c.id}
                        ...
                        <div className="mt-6 border-t border-[#111111]/12 pt-4">
                            <p className="mb-2 text-[10px] font-bold text-[#111111] uppercase">
                                {t('marketplace.maxPrice')} {priceMax < 500 ? `₾${priceMax}` : t('marketplace.maxPriceAny')}
                            </p>
                            <input
                                type="range"
                        ...
                        <button
                            ...
                            className="mt-5 w-full bg-[#111111] px-3 py-2 text-xs font-semibold text-white transition-colors hover:bg-[#333333]"
                        >
